...
import ttnn
from tests.ttnn.nightly.unit_tests.operations.conv.test_conv2d import BS, HS, WS, run_conv
...
@pytest.mark.parametrize(
    ...
    # fmt: off
    (
        (6,  3,   3,  928,    1600,   SliceWidth,   16,  ttnn.bfloat8_b, ttnn.bfloat16, (7, 7), (2, 2), (3, 3), (1, 1), 0,  ttnn.MathFidelity.LoFi  ),
