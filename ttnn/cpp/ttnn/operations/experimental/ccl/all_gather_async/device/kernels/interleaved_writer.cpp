            ...
            switch (tiles_to_put_in_current_packet) {
                case 2: {
                    ...
                    if (direction == 1) {
                        ...
                        uint64_t local_noc0_dest_noc_addr_tile_one =
                            get_noc_addr(tile_one_id, output_addrgen, 0 /*offset*/, 1 /*noc_id*/);
                        uint64_t local_noc0_dest_noc_addr_tile_two =
                            get_noc_addr(tile_two_id, output_addrgen, 0 /*offset*/, 1 /*noc_id*/);
                ...
                default: {
                    ...
                    if (direction == 1) {
                        ...
                        uint64_t local_noc0_dest_noc_addr =
                            get_noc_addr(tile_id, output_addrgen, 0 /*offset*/, 1 /*noc_id*/);
