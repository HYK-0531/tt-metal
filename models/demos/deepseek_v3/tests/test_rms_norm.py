...
@pytest.mark.parametrize(
    ...
    [
        ("decode", 128, 1, "attention_norm"),  # Batch decode with distributed and sharded inputs
        ("decode", 32, 1, "attention_norm"),  # Batch decode with non-dtributed but sharded inputs
    ],
)
