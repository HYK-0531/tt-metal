...
run_vgg_unet_n150_demo() {

 WH_ARCH_YAML=wormhole_b0_80_arch_eth_dispatch.yaml pytest -n auto models/demos/vgg_unet/demo/demo.py::test_demo --timeout 600

}

run_vgg_unet_n300_demo() {
