...
struct MorehBugReportRankCrtaOperation {
...
constexpr auto moreh_bug_report_rank_crta = ttnn::register_operation<
    "ttnn::prim::moreh_bug_report_rank_crta",
    ttnn::operations::moreh::moreh_bug_report_rank_crta::MorehBugReportRankCrtaOperation>();
}
