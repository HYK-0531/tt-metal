...
void MAIN {
    ...
    cb_wait_front(src_cb_id, per_core_block_tile_cnt * per_core_block_cnt);
    cb_reserve_back(out_cb_id, per_core_block_tile_cnt * per_core_block_cnt);
    ...
    //    cb_push_back(out_cb_id, per_core_block_tile_cnt * per_core_block_cnt);
    cb_pop_front(src_cb_id, per_core_block_tile_cnt * per_core_block_cnt);
