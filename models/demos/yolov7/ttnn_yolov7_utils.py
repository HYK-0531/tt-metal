...
def create_custom_preprocessor(mesh_mapper=None):
    def custom_preprocessor(model, name, ttnn_module_args):
        ...
        if isinstance(model, Yolov7_model):
            ...
            parameters["51"]["cv1"]["weight"] = ttnn.from_torch(
            ...
            parameters["51"]["cv2"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["51"]["cv3"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["51"]["cv4"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["51"]["cv5"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["51"]["cv6"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["51"]["cv7"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["102"]["0"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["102"]["1"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["103"]["0"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["103"]["1"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["104"]["0"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
            ...
            parameters["104"]["1"]["weight"] = ttnn.from_torch(
                conv_weight, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper
            )
...
def create_yolov7_input_tensors(batch_size=1, input_channels=3, input_height=640, input_width=640, model=False):
