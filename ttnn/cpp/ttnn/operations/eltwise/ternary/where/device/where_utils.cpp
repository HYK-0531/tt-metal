...
std::string get_kernel_file_path(KernelName kernel_name) {
    ...
    constexpr std::string_view writer = "ttnn/cpp/ttnn/operations/eltwise/unary/device/kernels";
    ...
    switch (kernel_name) {
        ...
        case KernelName::WriterNoBcastTTT: return fmt::format(writer, root, "writer_unary_interleaved_start_id.cpp");
        case KernelName::WriterNoBcastTST: return fmt::format(writer, root, "writer_unary_interleaved_start_id.cpp");
        case KernelName::WriterNoBcastTTS: return fmt::format(writer, root, "writer_unary_interleaved_start_id.cpp");
        case KernelName::WriterNoBcastTSS: return fmt::format(writer, root, "writer_unary_interleaved_start_id.cpp");
