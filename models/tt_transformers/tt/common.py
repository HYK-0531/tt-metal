...
class RopeScalingType(Enum):
    NONE = "none"  # Default - no scaling
    DEFAULT = "default"  # Alias for none
    LINEAR = "linear"  # Simple linear interpolation
    NTK_AWARE = "ntk"  # Current Llama3 implementation
    DYNAMIC = "dynamic"  # Dynamic NTK
    YARN = "yarn"  # YaRN implementation
...
def get_single_rot_mat(
    ...
    if rope_scaling["factor"] is not None:
    ...
    if scale_factor is not None:
        freqs = apply_scaling(freqs, scale_factor, scale_type, orig_context_len)
