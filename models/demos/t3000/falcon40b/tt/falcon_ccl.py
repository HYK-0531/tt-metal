...
class TT_CCL:
    ...
    def initialize_persistent_buffers(self):
        ...
        self.intermediary_buffer_specs = self.load_specs_from_file(
            "models/demos/t3000/falcon40b/tt/intermediary_PB_specs.json"
        )
        ...
        self.output_buffer_specs = self.load_specs_from_file("models/demos/t3000/falcon40b/tt/output_PB_specs.json")
