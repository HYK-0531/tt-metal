...
void kernel_main() {
    ...
    using input_tensor_shard_info = ShardedInfo<
        get_compile_time_arg_val(14),   // Memory layout
        get_compile_time_arg_val(15),   // The number of sharding cores
        get_compile_time_arg_val(16),   // The page size we offset each write to
        get_compile_time_arg_val(17),   // The number of pages in each sharding row not including padding pages
        get_compile_time_arg_val(18),   // This defines times when contiguous pages can't be calculated
        get_compile_time_arg_val(19),   // pages_per_shard_x
        get_compile_time_arg_val(20)>;  // pages_per_shard_y
