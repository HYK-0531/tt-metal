...
Pool2D::MultiCore::cached_program_t pool2d_multi_core_sharded_with_halo_v2_impl_new(
    ...
    tt::tt_metal::create_cb(
        in_scalar_cb_id_0, program, all_cores, in_scalar_cb_pagesize, in_scalar_cb_npages, tt::DataFormat::UInt32);
    ...
    if (is_avg_pool && split_reader && !one_scalar_per_core) {
        ...
        tt::tt_metal::create_cb(
            in_scalar_cb_id_1, program, all_cores, in_scalar_cb_pagesize, in_scalar_cb_npages, tt::DataFormat::UInt32);
        log_debug(
