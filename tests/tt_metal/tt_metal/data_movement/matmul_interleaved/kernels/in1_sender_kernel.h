...
void in1_sender_run(
    ...
    DeviceTimestampedData("Transaction size in bytes", in1_block_num_tiles);

    {
        ...
        for (uint32_t h = 0; h < num_subblocks_k_dim; h += subblock_k_dim) {
            ...
            noc_async_write_multicast(
                in1_start_address, in1_multicast_start_address, in1_block_num_tiles, num_of_receivers_y - 1);
