...
tt::tt_metal::operation::ProgramWithCallbacks all_gather_async_minimal_interleaved_helper(
    ...
    sender_writer_forward_kernel_config.compile_args.insert(
        sender_writer_forward_kernel_config.compile_args.end(), backward_args.begin(), backward_args.end());
    ...
    sender_writer_backward_kernel_config.compile_args.insert(
        sender_writer_backward_kernel_config.compile_args.end(), forward_args.begin(), forward_args.end());
